...
func TestHealthCheckWithOptionalParams(t *testing.T) {
	...
	_, err := client.Health.Check(context.TODO(), thegraph.HealthCheckParams{
		SkipEndpoints: thegraph.HealthCheckParamsSkipEndpointsTrue,
	})
	if err != nil {
