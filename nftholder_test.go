...
func TestNFTHolderGetByContract(t *testing.T) {
	...
	_, err := client.NFT.Holders.GetByContract(
		context.TODO(),
		"0xbd3531da5cf5857e7cfaa92426877b022e612cf8",
		thegraph.NFTHolderGetByContractParams{
			NetworkID: thegraph.NFTHolderGetByContractParamsNetworkIDMainnet,
		},
	)
	if err != nil {
